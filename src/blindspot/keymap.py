...
KEY_ACTIONS = (
    ...
    KeyAction("toggle_mute", tr_noop("Mute or unmute"), "Main", ("Shift+F4",), ("Shift+F4",)),
    KeyAction("volume_down", tr_noop("Volume down five percent"), "Main", ("Shift+F5",), ("Shift+F5",)),
    KeyAction("volume_up", tr_noop("Volume up five percent"), "Main", ("Shift+F6",), ("Shift+F6",)),
    ...
    KeyAction("open_bookmarks", tr_noop("Open Bookmarks tab"), "Main", ("Control+6",), ("Control+6",)),
    KeyAction(
        "open_audiobooks",
    ...
    KeyAction("open_podcasts", tr_noop("Open Podcasts tab"), "Main", ("Control+8",), ("Control+8",)),
    KeyAction(
        "open_saved_albums",
    ...
    KeyAction("open_new_music", tr_noop("Open Discover tab"), "Main", ("Control+0",), ("Control+0",)),
    KeyAction(
        "open_concerts",
        tr_noop("Open Concerts tab"),
        "Main",
        ("Control+Shift+G",),
        ("Control+Shift+G",),
    ),
