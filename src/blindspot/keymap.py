...
KEY_ACTIONS = (
    ...
    KeyAction("seek_backward", "Seek backward five seconds", "Main", ("F6",), ("F6",)),
    KeyAction("seek_forward", "Seek forward five seconds", "Main", ("F8",), ("F8",)),
    KeyAction(
        "previous_track",
    ...
    KeyAction("pause_resume", "Pause or resume", "Main", ("F7", "Space"), ("F7", "Space")),
    ...
    KeyAction("select_all", "Select all items", "Lists", ("Control+A",), ("Command+A",)),
    KeyAction(
        "open_similar_focused",
        "Open Last.fm mix for focused track",
        "Lists",
        ("Control+Shift+M",),
        ("Command+Shift+M",),
    ),
    KeyAction(
        ...
        "Start Last.fm mix for focused track",
        "Lists",
        ("Control+Shift+P",),
        ("Command+Shift+P",),
    ),
    KeyAction(
        ...
        "Open Last.fm mix for current track",
        "Main",
        ("Control+Alt+M",),
        ("Option+Command+M",),
    ),
    KeyAction(
        ...
        "Start Last.fm mix for current track",
        "Main",
        ("Control+Alt+P",),
        ("Option+Command+P",),
    ),
